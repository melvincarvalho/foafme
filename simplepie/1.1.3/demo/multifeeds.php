...
require_once('/home/foaf/public_html/v4/libAuthentication.php');
...
$a1 = $auth['agent']['holdsAccount'];
if ( $a1 ) {
  $feed->set_feed_url(array_merge(  $a1 ));
} else {
  $feed->set_feed_url( 'http://www.readwriteweb.com/' );
}
