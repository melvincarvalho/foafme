  ...
  */
  ...
  notifyWindow: function()
  {
    ...
    if (window.PFC_POPUP_WIN) {
      opener.document.getElementById("chat_open_chat_link").setAttribute("class", "chat_open_query usersettings");
      setCookie("chat_elgg_notify_status", "notify");
    }
  },
  unnotifyWindow: function()
  {
    ...
    // Elgg: adjust icon
    if (window.PFC_POPUP_WIN) {
      opener.document.getElementById("chat_open_chat_link").setAttribute("class", "chat_open usersettings");
      setCookie("chat_elgg_notify_status", 0);
    }
  },
